...
homeDir="/home/tva4/watershedMetagenomics/analysis/viral/VDNA/phaccs"

mkdir $homeDir/topResults

for ags in 15 34 42 50 85;
do 
cd $homeDir/AGS_"$ags"k_1G
mkdir topResults
cp *-V*DNA/phaccs*.txt topResults
cd topResults
...
ln -s `pwd`/$outName $homeDir/topResults
ln -s `pwd`/$errName $homeDir/topResults
done
