...
phaccsQsub="/home/tva4/scripts/phaccsScripts/phaccs.qsub"
...
qsub -N phaccs$sampleID  -v SAMPLE_ID="$sampleID",CSP_FILE="$cspFile",GENOME_SIZE="$genomeSize",GENOME_SIZE_K="$genomeSizeK",RESULTS_DIR="$resultsDir" $phaccsQsub
